...
# DAG disabled (schedule=None) on 2026-04-25. ASHP's drug-shortages site
# moved behind Cloudflare's managed challenge — neither cloudscraper,
# curl_cffi (any chrome impersonation), vanilla Playwright, nor
# playwright-stealth could pass it from the Linode prod IP. Re-enable by
# restoring the cron schedule once a viable Cloudflare-bypass path is
# wired in (rebrowser-playwright on a newer airflow base, or proxying the
# scraping through a non-flagged egress).
dag_id = "ashp"
